	...
	<form id="frmHeader" action="#">
		...
		<div class="ct_grid_top_wrap">								
			<div class="ct_grid_top_left">
				...
				<tr>
					<td class="small_td"><s:message code="quotation.salesOrdNo"/></p></td>
					<td><input type="text" name="DOC_NO" id="DOC_NO" readonly disabled="" data-dbcolumn="DOC_NO"></td>
					<td class="small_td"><s:message code="sales.ordertype"/></p></td>
					...
					<td class="small_td"><s:message code="quotation.poNo"/></p></td>
					<td><input type="text" name="PO_NO" id="PO_NO" readonly disabled="" ></td>
				</tr>
				<tr>
					<td class="small_td"><s:message code="quotation.soldTo"/></td>
					...
					<td class="small_td"><s:message code="quotation.shipTo"/></td>
					...
					<td class="small_td"><s:message code="sales.billto"/></td>
			...
			<table class="table_line" width="100%">
				<tr>
					<td class="small_td"><s:message code="quotation.salesOrg"/></p></td>
					...
					<td class="small_td"><s:message code="quotation.distributionCh"/></p></td>
					...
					<td class="small_td"><s:message code="quotation.division"/></p></td>
					<td><input type="text" name="DIV_CD" id="DIV_CD" readonly disabled=""/>
					<p class="data_under_text" name="DIV_NM" id="DIV_NM"></p></td>
				</tr>
				<tr>
					<td class="small_td"><s:message code="quotation.delPl"/></p></td>
				...
				<tr>
					<td class="small_td"><s:message code="quotation.priceDate"/></p></td>
					<td><input type="text" name="PRICE_DT" id="PRICE_DT" data-type="date" readonly disabled="" /></td>
					<td class="small_td"><s:message code="quotation.paymentTerms"/></p></td>
					...
					<td class="small_td"><s:message code="quotation.incoterms"/></td>
