...
<%-- 		</select> --%>
		...
		<a href='#' onclick="setting();"><i class="fa fa-cog"></i>Setting</a> | 
		<a href='#' onclick="edituser();"><i class="fa fa-edit"></i>Change</a> | 
...
// 		createCodeBox('LANGUAGE', false);
	...
	var setting = function(){
		...
		var pid = "p_PwChange";  //팝업 페이지의 취상위 div ID
		var param= {"INIT" : "N"};
